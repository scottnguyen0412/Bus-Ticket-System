    ...
    <section class="ftco-section contact-section ftco-degree-bg">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Address:</span> 123 Nguyen Tat Thanh, Da Nang</p>
          </div>
          <div class="col-md-3">
            <p><span>Phone:</span> <a href="tel://123456789">+ 1234 5678 9</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> <a href="mailto:scottnguyen0412@gmail.com">scottnguyen0412@gmail.com</a></p>
          </div>
          <div class="col-md-3">
